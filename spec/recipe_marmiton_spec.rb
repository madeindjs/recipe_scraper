...
describe "http://www.marmiton.org recipe crawler" do
  ...
  it 'should get ingredients' do
    array_exepted = ["2  avocats", "2  steaks hachés de boeuf", "2 tranches de cheddar", "feuille de salade", "0.5  oignon rouge", "1  tomate", "sésame", "1 filet d'huile d'olive", "1 pincée de sel", "1 pincée de poivre", "2  avocats", "2  steaks hachés de boeuf", "2 tranches de cheddar", "feuille de salade", "0.5  oignon rouge", "1  tomate", "sésame", "1 filet d'huile d'olive", "1 pincée de sel", "1 pincée de poivre"]
  ...
  it 'should export all informations to an array' do
    exepted_hash = { :cooktime => 7,
       ...
       :ingredients => ["2  avocats", "2  steaks hachés de boeuf", "2 tranches de cheddar", "feuille de salade", "0.5  oignon rouge", "1  tomate", "sésame", "1 filet d'huile d'olive", "1 pincée de sel", "1 pincée de poivre", "2  avocats", "2  steaks hachés de boeuf", "2 tranches de cheddar", "feuille de salade", "0.5  oignon rouge", "1  tomate", "sésame", "1 filet d'huile d'olive", "1 pincée de sel", "1 pincée de poivre"],
       :preptime => 20,
